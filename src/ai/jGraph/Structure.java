   ...
   import ai.jNeatCommon.CodeConstant;
   import ai.jNeatCommon.IOseq;
   import ai.jNeatCommon.NeatConstant;
   import ai.jneat.Gene;
   import ai.jneat.Genome;
   ...
   import ai.jNeatCommon.*;
	 ...
	 // tale vettore una volta costruito servir� per comporre
...
//		 int  sign_of_link = 0;
   ...
   */
	   ...
	   public void generate_virtual_Vertex_Edge_vertical() 
	  {
		 ...
		 //	  System.out.print(" , onode = " + _onode.name + " lev=" + _onode.level);
			...
			// curr_edge_id = nome del lato che si st� analizzando
			   curr_edge_id = _edge.name;
			...
			//
			   ...
			   //			System.out.print("\n Tratto  LINK NORMALE FORWARDING");
				  ...
				  // dato che il nodo � connesso in una catena singola ed unica
				  // il group id dei vertici � il nome del lato che li connette
	  ...
	  //   System.out.print("\n genera i piani XY in base alla matXY appena generata");
		 while (itr_plane.hasNext()) {
			...
			//	     System.out.print("\n Il piano di livello "+_plane.level +" ha "+_plane.dim_y+" righe  e avr� "+xdim+" colonne");
   ...
   * alla fine , quindi , � determinato depth_y = al numero REALE di livelli
   ...
   */                                   
	  ...
	  System.out.print("\n Dopo primo calcolo da out verso input la situazione � : "+max_b);
	  System.out.print("\n ******************************************************");
	  view();
	  ...
	  */   
	  ...
	  System.out.print("\n Dopo primo calcolo da inp  verso output  la situazione � : "+max_b);
	  System.out.print("\n ******************************************************");
	  //	  view();
	  ...
	  */
	  ...
	  // se il predecessore  non �  settato cio� se  non ha valori impostati cioe level = -1 e altitude = -1
	  ...
	  //	 System.out.print("\n ********* vertical and horizontal adj*************");
		 ...
		 while (changed)
		 {
			...
			// cerca il nodo pi� in basso verso cui il nodo � collegato
			// per fare questo esamino i nodi in uscita e vedo quale tra questi ha il
			// altitude pi� bassa o livello pi� alto;
			   ...
			   // se found = true allora il nodo _Vz � il pi� vicino
	  ...
	  */
	  ...
	  // per il momento non vengono visualizzati nodi che sono al di sotto dei sensori anche perch�
	  ...
	  // (potrebbero cio� esistere delle sub-network internamente alla rete funzionante;
   ...
   * allora tale connessione � intrastrato
   ...
   */                                
	   public void create_plane() 
	  {
		 ...
		 // intra-strato , memorizzando anche i nodi per i quali dovr� essere ricalcolato il livello
		 // in quanto dovranmno fare posto alle connessioni  intra-strato
		 // per fare ci� legge i nodi del livello trovato e li memorizza su un vettore;
	  ...
	  //		 System.out.print("\n sono su generate.grafo.step 3");
	   ...
	   // verticali distanti pi� di un livello
...
//		 System.out.print("\n xm = "+xm+", depth_x = "+depth_x+", dist_x = "+dist_x);
		 ...
		 //
			...
			// se si allora la distanza dalla precedente row � minore
