...
import ai.gui.ParamValue;
import ai.gui.vectTableModel;
...
public class Neat {
    ...
    /**
     * Probability of a disabled/gone node being initialized with connections to everything
     */
    public static double p_mutate_add_sensor;
    ...
    public static String getDescription(String xkey) {
        try {
            Class c = Class.forName("ai.jneat.Neat");
